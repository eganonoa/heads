...
wget https://download.lenovo.com/pccbbs/mobiles/gluj44us.exe || { echo "ERROR: wget not found" && exit 1; }
...
innoextract ./gluj44us.exe || { echo "Failed calling innoextract. Tool installed on host?" && exit 1;}
